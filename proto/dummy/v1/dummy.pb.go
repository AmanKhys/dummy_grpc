...
const file_dummy_v1_dummy_proto_rawDesc = "" +
	"\n" +
	"\x14dummy/v1/dummy.proto\"\x0e\n" +
	"\fDummyMessage2\x0e\n" +
	"\fDummyServiceB/Z-github.com/amankhys/grpc/dummy/proto/dummy/v1b\x06proto3"

var (
	file_dummy_v1_dummy_proto_rawDescOnce sync.Once
	file_dummy_v1_dummy_proto_rawDescData []byte
)

func file_dummy_v1_dummy_proto_rawDescGZIP() []byte {
	file_dummy_v1_dummy_proto_rawDescOnce.Do(func() {
		file_dummy_v1_dummy_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_dummy_v1_dummy_proto_rawDesc), len(file_dummy_v1_dummy_proto_rawDesc)))
	})
...
func file_dummy_v1_dummy_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_dummy_v1_dummy_proto_rawDesc), len(file_dummy_v1_dummy_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   1,
